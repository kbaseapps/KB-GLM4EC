...
class ModelGenerator:
    ...
    def __init__(self, optimizer_class = tf.keras.optimizers.Adam, lr = 2e-04, other_optimizer_kwargs = {}, model_weights = None, optimizer_weights = None):
...
class FinetuningModelGenerator(ModelGenerator):
    ...
    def create_model(self, seq_len, freeze_pretrained_layers = False):
        ...
        if self.output_spec.output_type.is_MLC:
...
class PretrainingModelGenerator(ModelGenerator):
    ...
    def __init__(self, create_model_function, n_annotations, create_model_kwargs = {}, optimizer_class = tf.keras.optimizers.Adam, lr = 2e-04, other_optimizer_kwargs = {}, \
...
def load_pretrained_model_from_dump(dump_file_path, create_model_function, create_model_kwargs = {}, optimizer_class = tf.keras.optimizers.Adam, lr = 2e-04, \
