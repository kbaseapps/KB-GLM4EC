...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'GLM4EC'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from GLM4EC.GLM4ECImpl import GLM4EC  # noqa @IgnorePep8
impl_GLM4EC = GLM4EC(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'GLM4EC'
