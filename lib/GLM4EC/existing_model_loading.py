...
def load_pretrained_model(local_model_dump_file_name, \
    ...
    return load_pretrained_model_from_dump(local_model_dump_file_name, create_model_function, create_model_kwargs = create_model_kwargs, optimizer_class = optimizer_class, lr = lr, \
